...
class InstructionsView(arcade.View):
    def __init__(self):
        super().__init__()
        self.background = arcade.load_texture("img/controls.png")

    def on_show(self):
        arcade.set_background_color((211, 168, 102))

    def on_draw(self):
        arcade.start_render()
        arcade.draw_lrwh_rectangle_textured(SCREEN_WIDTH / 2 - 192, SCREEN_HEIGHT / 2 - 170,
                                            400, 418, self.background)
        arcade.draw_text("How to Play", SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2 + 240,
                         arcade.color.BLACK, font_size=30, anchor_x="center")
        arcade.draw_text("Click to play!", SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2 - 200,
                         arcade.color.CHINESE_RED, font_size=25, anchor_x="center")
